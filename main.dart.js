...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = document,
        title = type$.HeadingElement._as(t1.querySelector("#title")),
        t2 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(type$.ButtonElement._as(t1.querySelector("#btn")), "click", t2._eval$1("~(1)?")._as(new A.main_closure(title)), false, t2._precomputed1);
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.FormElement, A.HeadingElement, A.SelectElement]);
